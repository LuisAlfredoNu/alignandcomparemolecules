...
void VectorAndMatrixOperations::alignEigenVectors(vector<vector<double>>& eigenVector_moleculeA,vector<vector<double>>& eigenVector_moleculeB){
	...
	double angle_eigVecA = getAngleBetween2Vectors(eigenVector_moleculeA[2], unitvectorZ);
	double angle_eigVecB = getAngleBetween2Vectors(eigenVector_moleculeB[2], unitvectorZ);

		eigenVector_moleculeA[2] = rotationOperationOverY(angle_eigVecA/2,eigenVector_moleculeA[2]);
		eigenVector_moleculeB[2] = rotationOperationOverY(angle_eigVecB/2,eigenVector_moleculeB[2]);
